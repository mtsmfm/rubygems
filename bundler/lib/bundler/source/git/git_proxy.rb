      ...
      class GitProxy
        ...
        def checkout
          ...
          unless path.exist?
            ...
            git %(remote add origin #{uri_escaped_with_configured_credentials}), :dir => path
          end

          git_retry %(fetch --force --quiet --depth 1 origin #{Shellwords.shellescape(ref)}:#{internal_ref_name}), :dir => path
        end
